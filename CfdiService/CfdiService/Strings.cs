...
namespace CfdiService
{
    public static class Strings
    {
        ...
        public static readonly string newEmployeeWelcomeMessge = "Bienvenidos a Nomisign, a la aplicación para revisar y firmar sus nominas. Visite este link http://{0}/nomisign/account/{1} para crear su contraseña.  Codigo de seguridad: {2}";

        public static readonly string newEmployeeWelcomeMessgeEmailSubject = "Bienvenidos a Nomisign";
