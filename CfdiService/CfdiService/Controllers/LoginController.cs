        ...
        public IHttpActionResult DoEmployeeLoginReset(EmployeeShape employeeShape)
        {
            ...
            if (employeeByCell.Count > 0)
            {
                ...
                try
                {
                    ...
                    {
                        try { SendEmail.SendEmailMessage(employee1.Company.BillingEmailAddress, string.Format(Strings.smsQuantityWarningSubject, employee1.Company.CompanyName), string.Format(Strings.smsQuantityWarning, httpDomain, employee1.Company.CompanyName, employee1.Company.SMSBalance)); } catch { }
